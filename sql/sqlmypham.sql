...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 17, 2022 lúc 08:44 AM
...
CREATE TABLE `account` (
  ...
  `dien_thoai` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `gioi_tinh` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(11, 'van', 'e10adc3949ba59abbe56e057f20f883e', 3, 'Nguyễn Đức Vân', '0396646090', 'Nam', 'Hà Nội'),
(12, 'a', 'c20ad4d76fe97759aa27a0c99bff6710', 3, 'a', '23654', 'Nam', 'dasdsad');
...
CREATE TABLE `banner` (
  ...
  `name_banner` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `image_banner` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(9, '', 'banner-quang-cao-my-pham.jpg'),
(10, '', 'banner-my-pham-dep-12-1024x390.png');
...
CREATE TABLE `logo_website` (
  ...
  `name_logo` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `image_logo` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(2, 'Mỹ phẩm cao cấp', 'logo.png'),
(3, 'Mỹ phẩm cao cấp', 'Pink playfull Sakura Flowers Logo.png'),
(4, 'Mỹ phẩm cao cấp', 'Pink playfull Sakura Flowers Logo (1).png');
...
CREATE TABLE `menu` (
  ...
  `link_menu` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(5, 'Làm Đẹp', 'page-menu/lamdep.php'),
(6, 'Khuyến Mãi', ''),
(7, 'Giới Thiệu', '');
...
CREATE TABLE `news` (
  ...
  `tittle_news` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `image_news` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `short_content` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `type_news` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `long_content` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `product` (
  ...
  `name_product` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `describe_product` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `price_product` int(10) NOT NULL,
  `image_product` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `type_product` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `useful_product` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parent_product` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `xuatxu` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `quy_cach` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `noi_dung` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `tinh_trang` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
(83, 'Son dưỡng môi Collagen Murad Rapid Collagen Infusion for Lip', 'Kem giúp giảm nám The Perfect Bleaching Cream - sản phẩm giúp giảm nám chuyên sâu giúp cải thiện da sạm nám, nhiều đốm nâu, gia tăng đàn hồi, làm mịn da hiệu quả.', 980000, 'small-kem-dieu-tri-mun-neostrata-spot-treatment.png', 'mặt', 'son dưỡng môi', 'trang điểm', 'USA', '100ml', '<p>dsds</p>\r\n', '', 0),
(84, 'Son dưỡng môi Collagen Murad Rapid Collagen Infusion for Lip', 'Kem giúp giảm nám The Perfect Bleaching Cream - sản phẩm giúp giảm nám chuyên sâu giúp cải thiện da sạm nám, nhiều đốm nâu, gia tăng đàn hồi, làm mịn da hiệu quả.', 980000, 'condolisa_180x180.jpg', 'mặt', 'son dưỡng môi', 'trang điểm', 'USA', '100ml', '<p>dsds</p>\r\n', 'Hết hàng', 0),
(85, 'Son dưỡng môi Collagen Murad Rapid Collagen Infusion for Lip', 'Kem giúp giảm nám The Perfect Bleaching Cream - sản phẩm giúp giảm nám chuyên sâu giúp cải thiện da sạm nám, nhiều đốm nâu, gia tăng đàn hồi, làm mịn da hiệu quả.', 980000, 'small-son-moi-Christian-Louboutin-Velvet-Matte-Lip.png', 'mặt', 'son dưỡng môi', 'trang điểm', 'USA', '100ml', '<p>dsds</p>\r\n', '', 0),
(87, 'dsadasd', 'dsadsadsad', 1111111111, '2a4cc61106984cf28422d1ed838f0c9c.png', 'sds', 'asd', 'AS', 'dasaa', 'asddas', '<p>AAAAAAAAAAAAAA</p>\r\n', '', 0);
...
CREATE TABLE `submenu` (
  ...
  `name_sub` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `link_sub` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `parent` int(50) NOT NULL,
  `type_sub` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `type_beauti` (
  `id_beauti` int(50) NOT NULL,
  `name_beauti` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `type_product` (
  ...
  `name_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `useful_product` (
  ...
  `name_useful` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `banner`
  MODIFY `id_banner` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `product`
  MODIFY `id_product` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
